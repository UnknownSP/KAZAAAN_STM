...
#define IO_SET_BLDC1_ENA() (D_GPIO_Set(GPIOC,GPIO_PIN_6))
#define IO_RESET_BLDC1_ENA() (D_GPIO_Reset(GPIOC,GPIO_PIN_6))
#define IO_SET_BLDC1_DIR() (D_GPIO_Set(GPIOC,GPIO_PIN_5))
#define IO_RESET_BLDC1_DIR() (D_GPIO_Reset(GPIOC,GPIO_PIN_5))

#define IO_SET_BLDC2_ENA() (D_GPIO_Set(GPIOA,GPIO_PIN_12))
#define IO_RESET_BLDC2_ENA() (D_GPIO_Reset(GPIOA,GPIO_PIN_12))
#define IO_SET_BLDC2_DIR() (D_GPIO_Set(GPIOA,GPIO_PIN_11))
#define IO_RESET_BLDC2_DIR() (D_GPIO_Reset(GPIOA,GPIO_PIN_11))

#define IO_SET_BLDC3_ENA() (D_GPIO_Set(GPIOB,GPIO_PIN_12))
#define IO_RESET_BLDC3_ENA() (D_GPIO_Reset(GPIOB,GPIO_PIN_12))
